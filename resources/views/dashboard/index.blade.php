...
<header class="section__container header__container">
    ...
    <img src="{{asset('Admin_dashboard/assets/header.jpg')}}" alt="header"/>
</header>

<div id="container_cardA">
...
<section class="section__container plan__container">
    ...
    <div class="plan__grid">
        ...
        <div class="plan__image">
            <img src="{{asset('Admin_dashboard/assets/plan-1.jpg')}}" alt="plan"/>
            <img src="{{asset('Admin_dashboard/assets/plan-2.jpg')}}" alt="plan"/>
            <img src="{{asset('Admin_dashboard/assets/plan-3.jpg')}}" alt="plan"/>
        </div>
    </div>
</section>
...
<section class="section__container lounge__container">
    <div class="lounge__image">
        <img src="{{asset('Admin_dashboard/assets/lounge-1.jpg')}}" alt="lounge"/>
        <img src="{{asset('Admin_dashboard/assets/lounge-2.jpg')}}" alt="lounge"/>
    </div>
...
<section class="section__container travellers__container">
    ...
    <div class="travellers__grid">
        <div class="travellers__card">
            <img src="{{asset('Admin_dashboard/assets/traveller-1.jpg')}}" alt="traveller"/>
            <div class="travellers__card__content">
                <img src="{{asset('Admin_dashboard/assets/client-1.jpg')}}" alt="client"/>
                <h4>Emily Johnson</h4>
                <p>Dubai</p>
            </div>
        </div>
        <div class="travellers__card">
            <img src="{{asset('Admin_dashboard/assets/traveller-2.jpg')}}" alt="traveller"/>
            <div class="travellers__card__content">
                <img src="{{asset('Admin_dashboard/assets/client-2.jpg')}}" alt="client"/>
                <h4>David Smith</h4>
                <p>Paris</p>
            </div>
        </div>
        <div class="travellers__card">
            <img src="{{asset('Admin_dashboard/assets/traveller-3.jpg')}}" alt="traveller"/>
            <div class="travellers__card__content">
                <img src="{{asset('Admin_dashboard/assets/client-3.jpg')}}" alt="client"/>
                <h4>Olivia Brown</h4>
                <p>Singapore</p>
            </div>
        </div>
        <div class="travellers__card">
            <img src="{{asset('Admin_dashboard/assets/traveller-4.jpg')}}" alt="traveller"/>
            <div class="travellers__card__content">
                <img src="{{asset('Admin_dashboard/assets/client-4.jpg')}}" alt="client"/>
                <h4>Daniel Taylor</h4>
                <p>Malaysia</p>
            </div>
        </div>
...
{{--<script src="{{asset('Admin_dashboard/js/import_files.js')}}"></script>--}}
</html>
